(function () {
  ...
  var relativeModuleUrl = new URL("frontend/js/main.js?v=20260602-search-nav", currentScript).href;

  import(relativeModuleUrl).catch(function (firstError) {
    import("/frontend/js/main.js?v=20260602-search-nav").catch(function (secondError) {
